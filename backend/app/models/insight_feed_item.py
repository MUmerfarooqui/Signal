...
class InsightFeedItem(Base):
    ...
    __table_args__ = (
        Index("idx_feed_org_detected", "org_id", text("detected_at DESC")),
        Index("idx_feed_org_expires", "org_id", text("expires_at DESC")),
    )
    ...
    ticket_count: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
